...
void Circulo()
{
    ...
    do {
        ...
        gotoxy(28, 16); printf("         ");   // campo do Per�metro
...
void Quadrado()
{
    ...
    do {
        ...
        gotoxy(28, 15); printf("         ");   // campo do Per�metro
        ...
        // leitura da op��o (1 para repetir, sem mensagem adicional)
        gotoxy(12, 23);
        scanf("%d", &OpcaoR);
...
void Losango()
{
    ...
    do {
        ...
        gotoxy(25, 15); printf("         "); // campo da �rea
        gotoxy(12, 23); printf("  ");      // campo da op��o
...
void RaizQuadrada() {
    ...
    gotoxy(3,10);
    printf("Quadrado do n�mero:.........[             ]");

    gotoxy(3,12);
    printf("Raiz quadrada do n�mero:....[             ]");
...
void Emprestimo() {
    ...
    gotoxy(25, 2);
    printf("Projeto CMP1046 - Empr�stimo Consignado");
    ...
    gotoxy(3, 8);
    printf("Valor do sal�rio mensal:...........[             ]");

    gotoxy(3, 10);
    printf("Valor do empr�stimo pretendido:....[             ]");
...
void CalcMediaAluno()
{
    ...
    gotoxy(3, 15);
    printf("M�dia final..........................[      ]", mediaFinal);
    gotoxy(3, 16);
	printf("Frequ�ncia...........................[      ]", freq);
	gotoxy(3, 18);
	printf("Situa��o.............................[             ]");
...
void CapitalGoias() 
{
    ...
    do {
        ...
        // título
        gotoxy(28, 2);
        printf("Projeto CMP1046 - Capital de Goi�s");

        // entrada
        gotoxy(3, 5);
        printf("Digite o nome da capital de Goi�s: ......[                        ]");
        gotoxy(41, 5);
        scanf("%49s", capital);
